...
test('no elements', t => {
    ...
    t.is(xml('bob\'config escape character'), 'bob&apos;config escape character');
});
    ...
    t.is(xml([{
        a: [{
            _attr: {
                ...
                url: 'http://google.com?config=opower&y=fun'
            }
        }, 'text']
    }]), '<a anglebrackets="this is &lt;strong&gt;strong&lt;/strong&gt;" url="http://google.com?config=opower&amp;y=fun">text</a>');
});
